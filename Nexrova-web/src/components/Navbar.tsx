      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/contact" className="text-slate-600 hover:text-indigo-600 font-medium whitespace-nowrap">Contact Us</Link>
            <Link href="/career" className="text-slate-600 hover:text-indigo-600 font-medium whitespace-nowrap">Career</Link>
