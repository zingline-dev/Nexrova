      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/about" className="text-slate-600 hover:text-indigo-600 font-medium whitespace-nowrap">About Us</Link>
            <Link href="/membership" className="text-slate-600 hover:text-indigo-600 font-medium whitespace-nowrap">Membership</Link>
            <Link href="/services" className="text-slate-600 hover:text-indigo-600 font-medium whitespace-nowrap">Services</Link>
            <Link href="/estimate" className="text-slate-600 hover:text-indigo-600 font-medium whitespace-nowrap">Pricing</Link>
            <Link href="/verification" className="text-slate-600 hover:text-indigo-600 font-medium whitespace-nowrap">Verification</Link>
          ...
          <details className="md:hidden group">
            ...
            <div className="fixed inset-0 top-20 bg-white z-[105] p-6 animate-in fade-in slide-in-from-top-4 duration-200">
              <div className="flex flex-col gap-6">
                ...
                <Link href="/estimate" className="text-xl font-bold text-slate-900 py-2 border-b border-slate-50">Pricing</Link>
                <Link href="/verification" className="text-xl font-bold text-slate-900 py-2 border-b border-slate-50">Verification</Link>
                <div className="pt-6">
